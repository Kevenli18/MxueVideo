...
class CourseOrg(models.Model):
    ...
    category = models.CharField(default='pxjg', max_length=20, choices=(('pxjg', '培训机构'), ('gr', '个人'),
                                                                        ('gx', '高校')), verbose_name='机构类别')
    click_nums = models.IntegerField(default=0, verbose_name='点击数')
    fav_nums = models.IntegerField(default=0, verbose_name='收藏数')
    image = models.ImageField(upload_to='org/%Y/%m', verbose_name='LOGO图')
    ...
    city = models.ForeignKey(CityDirt, verbose_name='所在城市', blank=True, null=True)
